...
export function EmailVerificationDialog({
  ...
  const handleSendVerification = async () => {
    ...
    if (!currentUser) {
      toast.error("No hay un SOLICITANTE autenticado para verificar.");
      return;
    }
    ...
    try {
      ...
      toast.success(
        "Correo de verificación enviado. Verifica tu bandeja de entrada."
      );

      // Después de enviar la verificación, esperamos la confirmación del SOLICITANTE
